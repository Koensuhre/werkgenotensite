    ...
    <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6">
      <div className="text-center">
        <h1 className="text-balance text-4xl font-semibold tracking-tight sm:text-5xl">
          Groei jouw bedrijf met Werkgenoten
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Krijg direct leads in jouw regio, bouw aan reviews en laat marketing aan ons over.
        </p>
        ...
        {[
          {
            ...
            t: "60% nieuwe omzet",
            d: "Gemiddeld percentage nieuwe klanten dat onze pro's via Werkgenoten haalt.",
          },
          {
            icon: <Users className="h-5 w-5" />,
            t: "12.480+ collega's",
            d: "Sluit je aan bij de grootste community van vakmensen in Nederland.",
          },
          {
            icon: <Star className="h-5 w-5" />,
            t: "Reviews die converteren",
            d: "Authentieke beoordelingen na elke afgeronde klus.",
          },
        ].map((b) => (
          <div
            key={b.t}
            className="bg-card-gradient shadow-card rounded-2xl border border-border/60 p-6"
          >
      ...
      <section
        id="aanmelden"
        className="bg-card-gradient shadow-card mt-16 rounded-2xl border border-border/60 p-8"
      >
        ...
        {alreadyPro && reviewStatus === "approved" && (
          <div className="mt-4 rounded-lg bg-brand/15 p-4 text-sm text-brand">
            Je bent al een goedgekeurde professional. Ga naar je{" "}
          ...
          <form onSubmit={onSubmit} className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2 mt-2 flex items-start gap-2 text-sm">
              ...
              <span className="text-muted-foreground">
                Je aanmelding wordt eerst door een admin gecontroleerd voordat je profiel zichtbaar
                wordt en je opdrachten kunt aannemen.
              </span>
            </div>
            <button
              type="submit"
              disabled={submitting || loading}
              className="sm:col-span-2 mt-2 rounded-lg bg-brand-gradient px-4 py-3 text-sm font-medium text-brand-foreground shadow-glow disabled:opacity-60"
            >
