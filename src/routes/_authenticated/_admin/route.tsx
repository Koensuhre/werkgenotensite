...
export const Route = createFileRoute("/_authenticated/_admin")({
  head: () => ({
    meta: [{ title: "Admin — Werkgenoten" }, { name: "robots", content: "noindex" }],
  }),
...
const nav = [
  ...
  {
    to: "/admin/review-opdrachten",
    label: "Te reviewen opdrachten",
    icon: ClipboardCheck,
    exact: false,
  },
  {
    to: "/admin/review-professionals",
    label: "Te reviewen professionals",
    icon: UserCheck,
    exact: false,
  },
...
function AdminLayout() {
  ...
  const stillResolving =
    sessionLoading || !user || rolesLoading || isFetching || roles === undefined;
